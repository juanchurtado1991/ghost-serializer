...
-keep class * implements com.ghost.serialization.core.contract.GhostRegistry {
    public <init>(...);
    *;
}

# Preserve ServiceLoader metadata for discovery
-keepnames class * implements com.ghost.serialization.core.contract.GhostRegistry
