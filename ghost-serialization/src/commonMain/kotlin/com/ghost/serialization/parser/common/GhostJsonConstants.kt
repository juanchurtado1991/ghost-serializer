...
object GhostJsonConstants {
    ...
    const val ERR_REQUIRED_FIELD_PREFIX = "Required field '"
    const val ERR_REQUIRED_FIELD_SUFFIX = "' missing in JSON"
    const val ERR_MISSING_DISCRIMINATOR = "Missing discriminator field for sealed class"
    const val ERR_UNKNOWN_DISCRIMINATOR_PREFIX = "Unknown type discriminator: "
    const val ERR_INVALID_ENUM_VALUE = "Invalid enum value"
    const val ERR_UNEXPECTED_ENUM_INDEX_PREFIX = "Unexpected enum index: "
