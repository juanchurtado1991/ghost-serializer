...
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| **Ghost** | **0.048 ±0.016** | **46.4** | **0.044 ±0.013** | **23.0** | **0.046 ±0.010** | **41.5** |
| KSerialization | 0.105 ±0.029 | 121.7 | 0.103 ±0.026 | 121.7 | 0.180 ±0.030 | 121.8 |
| Gson | 0.137 ±0.038 | 143.3 | 0.130 ±0.026 | 143.3 | 0.134 ±0.030 | 153.0 |
| Moshi | 0.177 ±0.037 | 112.5 | 0.173 ±0.039 | 112.5 | 0.157 ±0.046 | 112.5 |
| Jackson | 0.125 ±0.052 | 335.2 | 0.115 ±0.050 | 335.2 | 0.112 ±0.031 | 335.3 |

### Deserialization — 2000 objects (SYNC_FULL_LARGE)

| Engine | String (ms) | MEM (KB) | Bytes (ms) | MEM (KB) | Streaming (ms) | MEM (KB) |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| **Ghost** | **0.365 ±0.108** | **343.8** | **0.352 ±0.111** | **197.4** | **0.371 ±0.077** | **446.3** |
| Gson | 0.598 ±0.116 | 1140.8 | 0.599 ±0.197 | 1140.8 | 0.608 ±0.106 | 1159.3 |
| KSerialization | 0.734 ±0.309 | 1087.4 | 0.729 ±0.194 | 1087.4 | 1.326 ±0.244 | 1184.1 |
| Moshi | 0.960 ±0.179 | 949.9 | 0.962 ±0.165 | 949.9 | 0.831 ±0.107 | 949.9 |
| Jackson | 1.033 ±0.256 | 3255.6 | 0.930 ±0.335 | 3255.7 | 0.939 ±0.293 | 3255.7 |

### Serialization — 1000 objects (WRITING)

| Engine | String (ms) | MEM (KB) | Bytes (ms) | MEM (KB) | Streaming (ms) | MEM (KB) |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| **Ghost** | **0.116 ±0.051** | **77.1** | **0.112 ±0.020** | **77.1** | **0.116 ±0.027** | **80.6** |
| Jackson | 0.165 ±0.091 | 366.8 | 0.136 ±0.097 | 201.7 | 0.135 ±0.054 | 303.4 |
| KSerialization | 0.147 ±0.065 | 218.2 | 0.143 ±0.043 | 295.1 | 0.260 ±0.048 | 221.7 |
| Gson | 0.368 ±0.092 | 629.5 | 0.362 ±0.070 | 706.5 | 0.723 ±0.238 | 3259.2 |
| Moshi | 0.450 ±0.061 | 638.2 | 0.451 ±0.107 | 715.2 | 0.438 ±0.081 | 484.2 |

### Stress Tests

| Test | Ghost | Gson | KSer | Moshi | Jackson |
|:---|:---:|:---:|:---:|:---:|:---:|
| Deep Nesting — 20 levels (ms) | **0.004 ±0.012** | 0.007 | 0.007 | 0.012 | 0.013 |
| Malformed JSON — resilience (ms) | **0.009 ±0.001** | 0.015 | 0.020 | 0.021 | 0.024 |
