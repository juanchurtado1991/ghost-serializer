...
internal object GhostEmitterConstants {
    ...
    const val STR_ENVELOPE_ROUTE_WHEN = "return when (envelope.%L)"
    ...
    const val STR_ENVELOPE_GENERIC_RETURN = "return envelope.%L\n"
    const val STR_ENVELOPE_PARSE_PAYLOAD = "val envelope = deserialize(%T(%L))\nreturn %L(envelope)"
